...
export default function PosCompatibilityPage({ accessToken, adminFetch, AdminShell, adminContext, onLogout }) {
  ...
  return <AdminShell active="/admin/pos-compatibility" adminContext={adminContext} onLogout={onLogout}><section className="space-y-6">
